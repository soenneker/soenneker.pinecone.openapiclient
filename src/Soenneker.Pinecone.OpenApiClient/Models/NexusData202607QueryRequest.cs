...
namespace Soenneker.Pinecone.OpenApiClient.Models
{
    ...
    public partial class NexusData202607QueryRequest : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// <summary>Client-generated id shared by the turns of one Compare run, so a query cap counts them as one action rather than several. Where the cap applies, a group is limited to 3 turns and a fourth is refused with `409`. Omit for a normal query.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string ComparisonGroup { get; set; }
#endif
        /// <summary>Set `false` to skip synthesis, the same as `retrieval_only`.</summary>
...
#nullable restore
        ...
        /// <summary>A catalog model id from `GET /models`, or a tier name (`lite`, `standard`, `pro`) to let the deployment resolve one. New session only; pinned for the session&apos;s life.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string Model { get; set; }
#endif
        /// <summary>Ordered fallback list, tried in turn. Takes precedence over `model`.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequestShapeProperty? Shape { get; set; }
#nullable restore
#else
        public global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequestShapeProperty Shape { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>Tool names the turn may call. New session only; pinned for the session&apos;s life.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Tools { get; set; }
#endif
        /// <summary>Search workflow for this turn. Ignored for work contexts, which always run the `work` runtime.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequest"/> and sets the default values.
        /// </summary>
        public NexusData202607QueryRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "shape", n => { Shape = n.GetObjectValue<global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequestShapeProperty>(global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequestShapeProperty.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Pinecone.OpenApiClient.Models.NexusData202607QueryRequestShapeProperty>("shape", Shape);
