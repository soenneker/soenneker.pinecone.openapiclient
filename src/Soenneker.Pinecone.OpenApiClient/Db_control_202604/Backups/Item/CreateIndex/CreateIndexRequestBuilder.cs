...
using System;
namespace Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex
{
    /// <summary>
    /// Builds and executes requests for operations under \db_control_2026-04\backups\{backup_id}\create-index
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CreateIndexRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex.CreateIndexRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/db_control_2026-04/backups/{backup_id}/create-index", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex.CreateIndexRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateIndexRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/db_control_2026-04/backups/{backup_id}/create-index", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex.CreateIndexRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex.CreateIndexRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Backups.Item.CreateIndex.CreateIndexRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
