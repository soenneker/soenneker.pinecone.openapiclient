...
using Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.Backups;
...
using System;
namespace Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \db_control_2026-04\indexes\{index_name}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithIndex_nameItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The backups property</summary>
        public global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.Backups.BackupsRequestBuilder Backups
        {
            get => new global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.Backups.BackupsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.WithIndex_nameItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithIndex_nameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/db_control_2026-04/indexes/{index_name}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.WithIndex_nameItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithIndex_nameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/db_control_2026-04/indexes/{index_name}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.WithIndex_nameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Pinecone.OpenApiClient.Db_control_202604.Indexes.Item.WithIndex_nameItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
